        ...
        <div className="border rounded-xl p-6 md:p-10 relative overflow-hidden bg-background">
          ...
          <div className="relative flex flex-col items-center gap-6 text-center pt-4">
            ...
            <p className="mx-auto max-w-lg text-muted-foreground text-balance">
              Open to opportunities, collaborations, and discussions around software development, AI, and web technologies. Feel free to reach out—I'd be happy to connect.{" "}
              <Link
